...
<div class="card"><div class="card-header"><h2><?php echo $isVolunteerManagement ? '志工名單' : '平台帳號'; ?></h2><p><?php echo $isVolunteerManagement ? '管理志工申請與開通狀態' : '新註冊帳號預設為待審核'; ?></p></div><div class="card-body"><table class="data-table users-table"><thead><tr><th>姓名</th><th>帳號</th><th>角色</th><th>電話</th><th>電子郵件</th><th>教育訓練</th><th>狀態</th><th>操作</th></tr></thead><tbody>
